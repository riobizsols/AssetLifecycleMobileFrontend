...
const MOBILE_SCREEN_MAP = {
  ...
  MAINTENANCEAPPROVAL: 'MaintenanceSupervisor',
...
export const navigationService = {
  ...
  getNavigationLabel(appId) {
    const labelMap = {
      ...
      MAINTENANCEAPPROVAL: 'navigation.maintenanceSupervisor',
  ...
  getNavigationSubtitle(appId) {
    const subtitleMap = {
      ...
      MAINTENANCEAPPROVAL: 'navigation.updateMaintenanceSchedules',
